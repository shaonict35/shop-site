    ...
    <nav className="mobile-bottom-nav" aria-label="Mobile navigation">
      <div className="mobile-nav-items">
        ...
        <Link href="/" className="mobile-nav-item" aria-label="Home">
          <svg fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
        ...
        {/* 2. BRANDS */}
        <Link href="/brands" className="mobile-nav-item" aria-label="Brands">
          <svg fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
        ...
        {/* 3. CATEGORIES */}
        <Link href="/shop" className="mobile-nav-item" aria-label="Categories">
          <svg fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
        ...
        {/* 4. CART */}
        <button type="button" className="mobile-nav-item" onClick={() => setCartOpen(true)} style={{ position: "relative", cursor: "pointer" }} aria-label={`View Shopping Cart (${cartCount} items)`}>
          <svg fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
        ...
        {/* 5. CHAT */}
        <button type="button" className="mobile-nav-item" onClick={handleOpenChat} style={{ cursor: "pointer" }} aria-label="Customer Support Chat">
          <svg fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24" width="22" height="22" aria-hidden="true">
